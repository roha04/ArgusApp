...
//
//        binding.textViewLogin.setOnClickListener {
//            finish() // Повертаємося до екрану входу
//        }
//    }
//
//    private fun validateInput(name: String, email: String, password: String, confirmPassword: String): Boolean {
...
//                            "displayName" to name,
//                            "email" to email,
//                            "role" to "citizen",  // Явно встановлюємо роль "громадянин"
//                            "createdAt" to FieldValue.serverTimestamp(),
//                            "photoUrl" to "", // Порожнє значення для фото профілю
//                            "phone" to ""  // Порожнє значення для телефону
//                        )
//
//                        db.collection("users").document(user.uid)
//                            .set(userMap)
...
//                                showProgressBar(false)
//                                startActivity(Intent(this, CitizenMainActivity::class.java))
//                                finishAffinity() // Закриваємо всі попередні екрани
//                            }
//                            .addOnFailureListener { e ->
//                                showProgressBar(false)
//                                showError("Помилка створення профілю: ${e.message}")
//                                auth.currentUser?.delete() // Видаляємо користувача, якщо не вдалося створити профіль
//                            }
//                    }
//                } else {
//                    showProgressBar(false)
