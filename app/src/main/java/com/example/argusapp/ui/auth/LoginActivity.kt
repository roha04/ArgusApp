...
//
//        // Create alert dialog with custom view - using default theme
//        val dialog = AlertDialog.Builder(this)
//            .setTitle("Відновлення паролю")
//            .setView(dialogView)
//            .setPositiveButton("Надіслати", null) // Set null initially to override default behavior
...
//        dialog.show()
//
//        // Set click listener for positive button after dialog is shown
//        // This prevents automatic dismissal on click if validation fails
//        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
//            val email = emailEditText.text.toString().trim()
//
//            // Validate email
...
//
//                // Attempt password reset
//                resetPassword(email, dialog, progressIndicator)
//            }
//        }
//    }
//
    /**
     * Sends password reset email with improved feedback
     */
    private fun resetPassword(email: String, dialog: AlertDialog, progressIndicator: View) {
        auth.sendPasswordResetEmail(email)
            .addOnSuccessListener {
                // Close dialog
                dialog.dismiss()
                ...
                Snackbar.make(
                    ...
                    "Інструкції з відновлення паролю надіслані на вашу електронну пошту",
                    Snackbar.LENGTH_LONG
                ).setBackgroundTint(resources.getColor(R.color.colorSuccess, theme))
            ...
            .addOnFailureListener { e ->
                ...
                val emailLayout = dialog.findViewById<TextInputLayout>(R.id.textInputLayoutResetEmail)
                emailLayout?.error = errorMessage
            }
    }
//    private fun showForgotPasswordDialog() {
...
//                    resetPassword(email)
//                } else {
//                    Toast.makeText(this, "Введіть email для відновлення", Toast.LENGTH_SHORT).show()
//                }
//            }
...
//                com.google.android.material.snackbar.Snackbar.make(
//                    binding.loginRoot,
//                    "Помилка відновлення паролю: ${e.localizedMessage}",
//                    com.google.android.material.snackbar.Snackbar.LENGTH_LONG
//                ).show()
//            }
//    }
...
//
//        binding.textViewRegister.setOnClickListener {
//            // Переходимо до реєстрації - доступно тільки для громадян
//            startActivity(Intent(this, RegisterActivity::class.java))
//        }
//
//        // Додаємо опцію "Забули пароль?"
//        binding.textViewForgotPassword.setOnClickListener {
//            showForgotPasswordDialog()
//        }
//    }
...
//                    finish()
//                } else {
//                    // Document doesn't exist - DO NOT CREATE NEW USERS HERE
//                    showError("Профіль користувача не знайдено")
//                    auth.signOut() // This is correct - sign out if no profile exists
//                }
//            }
//            .addOnFailureListener { e ->
//                showProgressBar(false)
